...
function enviarMensagemTelegram($mensagem, $email) {
    ...
    $telegramBotToken = '6779281813:AAEAIFDHVyyjto3O1ioYYP0aX7bPTM-vde4'; 
    $telegramChatID = '1002099478398';
...
try {
    ...
    $mail->SMTPAuth = true;
    $mail->Username = 'Grennrifas@outlook.com'; // SEU EMAIL AQUI VEI PELA MOR DE DEUS 
    $mail->Password = 'Gt260106'; // SENHA DO SEU EMAIL MANO
    $mail->SMTPSecure = 'tls';
    ...
    $mail->setFrom('Grennrifas@outlook.com', 'Rifa online');  //AQUI VOCE TEM QUE COLOCAR O QUE FALEI ALI EM CIMA E COLOCA SEU EMAIL OUTLOOK
